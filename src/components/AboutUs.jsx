...
// //create the about us page with the following sections:
// // 1. Our Story - A brief introduction to the company and its mission
// // 2. The Beginning - The origin story of how the company was founded
// // 3. What We Believe - A grid of the company's core values with icons and descriptions
// // 4. Stories That Inspire Us - A carousel of real student testimonials with images and quotes
// // 5. Key Metrics - A section highlighting important statistics about the company and its impact
// // 6. Join Us - A call-to-action encouraging visitors to sign up or learn more about the company
...
//           </h2>
//           <p className="text-lg text-gray-600 leading-relaxed">
//             Planly began with a simple realization: students are juggling more than ever, yet the tools we use haven&apos;t evolved. We&apos;re here to change that.
//           </p>
//         </div>
//         <div className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-32 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
//           <div className="relative">
...
//             <div className="space-y-4 text-gray-600 leading-relaxed">
//               <p>
//                 It started during finals week. I was sitting in a cramped dorm room, surrounded by coffee cups, sticky notes, and three different planners—none of which were helping. The stress was palpable, and the tools were failing.
//               </p>
//               <p>
//                 &quot;There has to be a better way,&quot; I thought. Not just a prettier calendar, but something that truly understands the rhythm of student life. The late nights, the group projects, the panic before deadlines, the joy of small wins.
//               </p>
//               <p>
//                 That night, Planly was born. What started as a side project to help friends has grown into a movement. Today, we&apos;re a team of 12, serving students across 150+ universities, but our mission remains the same: <span className="text-purple-600 font-medium">every student deserves to feel in control.</span>
//               </p>
//             </div>
//             <div className="flex items-center gap-4 pt-4">
//               <div className="w-14 h-14 rounded-full bg-purple-100 flex items-center justify-center text-purple-700 font-bold text-xl border-2 border-purple-200">  
...
//               const IconComponent = value.icon;
//               return (
//                 <div key={index} className="group relative p-8 rounded-2xl bg-gray-50 border border-gray-100 hover:bg-white hover:shadow-xl hover:shadow-gray-200/50 hover:border-gray-200 transition-all duration-300">
//                   <div className={`w-14 h-14 rounded-xl ${value.color} flex items-center justify-center mb-6`}>
//                     <IconComponent className="w-7 h-7" />
//                   </div>
//                   <h4 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-purple-600 transition-colors">
...
//                   <div className="flex-1 text-center md:text-left">
//                     <p className="text-xl md:text-2xl text-gray-900 font-medium leading-relaxed mb-6">
//                       &quot;I was overwhelmed with assignments and deadlines. Planly didn't just organize my schedule—it gave me back my confidence.&quot;
//                     </p>
//                     <div>
//                       <p className="text-gray-900 font-semibold text-lg">Sarah Chen</p>
//                       <p className="text-purple-600">Computer Science Major</p>
...
//                     key={index}
//                     className={`h-2 rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2 ${
//                       index === 0 ? 'w-8 bg-purple-600' : 'w-2 bg-gray-300 hover:bg-gray-400'
//                     }`}
//                     aria-label={`View story from ${["Sarah Chen", "Marcus Johnson", "Emily Rodriguez"][index]}`}
...
//             { number: "2M+", label: "Tasks Completed", icon: Star },
//             { number: "98%", label: "Satisfaction Rate", icon: Star },
//             { number: "150+", label: "Universities", icon: Building },
//           ].map((stat, index) => {
//             const IconComponent = stat.icon;
...
// import { useState, useEffect, useRef } from "react";
// import { Heart, Lightbulb, Users, Target, Quote, Sparkles, BookOpen, Star, ArrowRight, CheckCircle } from "lucide-react";
// import Link from "next/link";

// // Define Building icon component since it's not in lucide-react
// function Building({ className = "w-6 h-6" }) {
//   return (
//     <svg 
//       className={className} 
//       width="24" 
...
//                     </p>
//                     <div>
//                       <p className="text-gray-900 font-semibold text-lg">{stories[activeStoryIndex].author}</p>
//                       <p className="text-purple-600">{stories[activeStoryIndex].role}</p>
//                       <p className="text-gray-500 text-sm">{stories[activeStoryIndex].school}</p>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//                     className={`h-2 rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2 ${
//                       index === activeStoryIndex ? 'w-8 bg-purple-600' : 'w-2 bg-gray-300 hover:bg-gray-400'
//                     }`}
//                     aria-label={`View story from ${story.author}`}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white/90 mb-6 tracking-tight">
            Built in a Dorm Room,<br />
            <span className="bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent">Loved Worldwide</span>  
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-32">
          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-purple-900/20">
              ...
              {/* Floating info card - dark theme */}
              <div className="absolute bottom-6 left-6 right-6 p-5 rounded-xl bg-[#1A1A23]/90 backdrop-blur-md border border-white/10 shadow-xl">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-white/90 font-semibold mb-1">The Beginning</p>
                    <p className="text-white/50 text-sm">2019 • University of Michigan</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Decorative blurred circles */}
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-purple-600/20 rounded-full blur-2xl -z-10" aria-hidden="true" />
            <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-indigo-600/20 rounded-full blur-2xl -z-10" aria-hidden="true" />
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-white/60 leading-relaxed">
              ...
              <p>
                That night, Planly was born. What started as a side project to help friends has grown into a movement. Today, we&apos;re a team of 12, serving students across 150+ universities, but our mission remains the same: <span className="text-purple-400 font-medium">every student deserves to feel in control.</span>
              </p>
            </div>

            {/* Founder info - dark theme */}
            <div className="flex items-center gap-4 pt-4">
              <div className="w-14 h-14 rounded-full bg-purple-500/20 flex items-center justify-center text-purple-400 font-bold text-xl border-2 border-purple-500/30">  
                PI
              </div>
              <div>
                <p className="text-white/90 font-semibold">Patrick Iyiakimo</p>
              ...
              <div className="ml-auto">
                <img 
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/University_of_Michigan_logo.svg/1200px-University_of_Michigan_logo.svg.png"
                  alt="University of Michigan logo"
                  className="h-8 opacity-40 grayscale hover:grayscale-0 transition-all filter brightness-0 invert"
                />
              </div>
            </div>
          </div>
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            <h3 className="text-3xl sm:text-4xl font-bold text-white/90 mb-4">What We Believe</h3>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {values.map((value, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className="group relative p-8 rounded-2xl bg-[#1A1A23] border border-white/5 hover:border-purple-500/20 hover:bg-[#1E1E2A] transition-all duration-300"
                >
                  <div className={`w-14 h-14 rounded-xl ${value.color} flex items-center justify-center mb-6`}>
                    <IconComponent className="w-7 h-7" />
                  </div>
                  <h4 className="text-xl font-bold text-white/90 mb-3 group-hover:text-purple-400 transition-colors">
                    {value.title}
                  </h4>
        ...
        {/* Stories Section - Static Version */}
        <div className="mb-32">
          <div className="text-center mb-12">
            <h3 className="text-3xl sm:text-4xl font-bold text-white/90 mb-4">Stories That Inspire Us</h3>
            <p className="text-white/60">Real students, real transformations</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {stories.map((story, index) => (
              <div 
                key={index}
                className="p-6 rounded-2xl bg-[#1A1A23] border border-white/5 hover:border-purple-500/20 transition-all duration-300"
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <p className="text-white/90 font-semibold">{story.author}</p>
                    <p className="text-purple-400 text-sm">{story.role}</p>
                    <p className="text-white/50 text-xs">{story.school}</p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {stats.map((stat, index) => {
            ...
            return (
              <div 
                key={index} 
                className="text-center p-6 rounded-2xl bg-[#1A1A23] border border-white/5 hover:border-purple-500/20 transition-all duration-300 group"
              >
                ...
                <div className="text-3xl sm:text-4xl font-bold text-white/90 mb-2">{stat.number}</div>
        ...
        <div className="text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 p-3 rounded-2xl bg-[#1A1A23] border border-white/5">
            <div className="px-6 py-3">
              <p className="text-white/90 font-semibold mb-1">Join our growing family</p>
              <p className="text-white/50 text-sm">Be part of something meaningful</p>
            </div>
            <Link
              href="/signup"
              className="group flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-xl font-semibold hover:from-purple-600 hover:to-indigo-600 transition-all duration-300 shadow-lg shadow-purple-500/25 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-[#0A0A0F]"
            >
              <span>Get Started Free</span>
              <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
            </Link>
